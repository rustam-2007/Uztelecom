<template>
  <header class="w-full bg-white dark:bg-[#0f172a] border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
...
const navbarItems = ref([
  { name: 'Xizmat haqida', link: '#' },
  { name: 'Ariza yuborish', link: '#' },
  { name: 'Imkoniyatlar', link: '#' },
  { name: 'Afzalliklar', link: '#' },
  { name: 'Qanday boshlash kerak', link: '#' },
  { name: 'Tariflar', link: '#' },
])
...
// Tema o‘zgarganda <html> elementga dark klass qo‘shish
watchEffect(() => {
  if (isDark.value) {
